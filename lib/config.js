...
module.exports = function(env, fs) {
  ...
  _.extend(Config.prototype, {
    ...
    load: function(customConfig) {
      ...
      addEnvVar(envConfig.payload, 'cache', env.ROX_CACHE_PAYLOAD);
      addEnvVar(envConfig.payload, 'print', env.ROX_PRINT_PAYLOAD);
      addEnvVar(envConfig.payload, 'save', env.ROX_SAVE_PAYLOAD);

      _.extend(this, merge(config, envConfig));
    },
